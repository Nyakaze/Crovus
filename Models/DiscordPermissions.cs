...
public sealed record DiscordPermissionOverwrite(Snowflake Id, PermissionOverwriteType Type,
    DiscordPermissions Allow = DiscordPermissions.None, DiscordPermissions Deny = DiscordPermissions.None);
